...
//        }
    ...
    {
        return new CubicBezierSegment(_p1.clone(), new Point((_p2.x + 6 * _p1.x - _p0.x) / 6, (_p2.y + 6 * _p1.y - _p0.y) / 6), new Point((-_p3.x + 6 * _p2.x + _p1.x) / 6, (-_p3.y + 6 * _p2.y + _p1.y) / 6), _p2.clone());
    }
    ...
    override flash_proxy function getProperty(name:*):*
    {
        ...
        if (index < 0 || 3 < index || !(name is String))
	        throw new ArgumentError('Prop name must be int in range 0 to 3.');
    ...
    override flash_proxy function setProperty(name:*, value:*):void
    {
        ...
        if (index < 0 || 3 < index || !(name is String))
            throw new ArgumentError('Prop name must be int in range 0 to 3.');
        if (!(value is Point))
			throw new ArgumentError('Value must be instance of flash.geom.Point.');
